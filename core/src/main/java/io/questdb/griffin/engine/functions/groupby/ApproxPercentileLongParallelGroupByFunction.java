...
public class ApproxPercentileLongParallelGroupByFunction extends DoubleFunction implements GroupByFunction, BinaryFunction {
    ...
    public ApproxPercentileLongParallelGroupByFunction(Function exprFunc, Function percentileFunc, int precision, int funcPosition) {
    ...
    public double getDouble(Record rec) {
        ...
        return histogramA.of(ptr).getValueAtPercentile(percentile * 100);
    }
